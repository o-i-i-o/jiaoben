...
.NOTES
    ...
    版本: 1.4
    更新：与指定的BAT脚本逻辑完全一致
    在powershell窗口先执行 Set-ExecutionPolicy Bypass -Scope Process -Force 再运行脚本
#>

# 配置参数
$outputFolder = "C:\NetworkConfigBATScripts"
$subnetMask = "255.255.255.0"
$ipv6PrefixLength = "96"  # 与示例保持一致
$defaultGatewayIPv4 = "192.168.2.1"
$defaultGatewayIPv6 = "FE80::D238"  # 与示例保持一致
